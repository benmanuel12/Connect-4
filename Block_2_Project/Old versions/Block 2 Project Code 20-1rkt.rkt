...
(define button0 (new button%
                     ...
                     [callback (λ (b e) (send slot-0-0 set-label yellow))]
                     ))
...
(define array-reflect (λ () (for ([i board])
                              (cond
                                (
                              (map (λ (b e) (send slot-0-0 set-label yellow)) i))))
...
;that slot
(define place-piece (λ (board turn-done turn-marker column)
                      (cond
                        ((equal? turn-done #f)
                         (cond
                           ((equal? turn-marker 1)
...
(define place-piece-column-0 (λ ()
                               (place-piece board turn-done turn-marker 0)
                               (array-reflect)))
  
(define place-piece-column-1 (λ ()
                               (place-piece board turn-done turn-marker 1)
                               (array-reflect)))

(define place-piece-column-2 (λ ()
                               (place-piece board turn-done turn-marker 2)
                               (array-reflect)))

(define place-piece-column-3 (λ ()
                               (place-piece board turn-done turn-marker 3)
                               (array-reflect)))

(define place-piece-column-4 (λ ()
                               (place-piece board turn-done turn-marker 4)
                               (array-reflect)))

(define place-piece-column-5 (λ ()
                               (place-piece board turn-done turn-marker 5)
                               (array-reflect)))

(define place-piece-column-6 (λ ()
                               (place-piece board turn-done turn-marker 6)
                               (array-reflect)))